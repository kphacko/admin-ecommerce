...
<head>
    ...
    <!-- END PAGE LEVEL PLUGINS/CUSTOM STYLES -->
      ...
      <!-- BEGIN Custom table CUSTOM STYLES -->
                ...
                <ul class="list-unstyled menu-categories" id="accordionExample">
                    ...
                    <li class="menu">
                        ...
                        <ul class="collapse submenu list-unstyled" id="orders" data-parent="#accordionExample">
                            ...
                            <li>
                                <a href="component_accordion.html"> Completed Orders  </a>
                            </li>
                    ...
                    <li class="menu">
                        <a href="uploadImage.php" aria-expanded="false" class="dropdown-toggle">
                            <div class="">
                    ...
                    <li class="menu">
                        ...
                        <ul class="collapse submenu list-unstyled" id="reports" data-parent="#accordionExample">
                            ...
                            <li>
                                <a href="component_accordion.html"> Add Products  </a>
                            </li>
