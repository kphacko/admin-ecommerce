...
<div class="form-group">
    <p>Enter Design Details</p>
               ...
               <div class="form-check mt-2">
                                            <label class="switch s-icons s-outline  s-outline-primary   mr-2" style="height: 11px !important;">
                                                <input type="checkbox" >
